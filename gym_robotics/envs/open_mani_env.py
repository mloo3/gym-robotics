...
class OpenManiEnv(robot_env.RobotEnv):
    ...
    def __init__(
        ...
        super(OpenManiEnv, self).__init__(
    ...
    def _viewer_setup(self):
        body_id = self.sim.model.body_name2id('robot0:gripper_main_link')
    ...
    def render(self, mode='human', width=500, height=500):
        self.mode = mode
        return super(OpenManiEnv, self).render(mode, width, height)
